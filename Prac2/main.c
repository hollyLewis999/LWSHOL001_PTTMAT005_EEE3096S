...
//static uint8_t patterns1[6] = {0000001, 0000001, 0000001, 0000001, 0000001, 0000001};
static uint16_t address = 0;
static uint8_t LED_Pattern;
static uint16_t PINS[8] = { GPIO_PIN_0,GPIO_PIN_1,GPIO_PIN_2,GPIO_PIN_3,GPIO_PIN_4,GPIO_PIN_5,GPIO_PIN_6,GPIO_PIN_7};
static uint32_t timeDelay = 1000;
...
int main(void)
{
  ...
  //pointer to configeration and state of timer
...
void TIM16_IRQHandler(void)
{
	...
	LED_Pattern = read_from_address(address);

	if (LED_Pattern != patterns[address]) {
			LED_Pattern = 1;
		}
	address++;
	if (address ==6){
